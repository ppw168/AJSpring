...
public class F57AgencyEntity implements Serializable {
	...
	public void setNuAvgBal(BigDecimal nuAvgBal) {
	...
	public void setNuAvgLoan(BigDecimal nuAvgLoan) {
	...
	public void setNuAvgLoss(BigDecimal nuAvgLoss) {
	...
	public void setNuHits(BigDecimal nuHits) {
		this.nuHits = nuHits;
	}
	...
	public void setNuPocDigits(BigDecimal nuPocDigits) {
	...
	public void setNuSsnsLoaded(BigDecimal nuSsnsLoaded) {
	...
	public void setNuSuppressCtr(BigDecimal nuSuppressCtr) {
	...
	public void setNuTxBatch(BigDecimal nuTxBatch) {
	...
	public void setNuTxElect(BigDecimal nuTxElect) {
	...
	public void setNuTxScreen(BigDecimal nuTxScreen) {
	...
	public void setNuTxTip(BigDecimal nuTxTip) {
	...
	public void setNuUsersLoaded(BigDecimal nuUsersLoaded) {
	...
	public void setTxAuditTape(String txAuditTape) {
	...
	public void setTxContact(String txContact) {
	...
	public void setF57Borrowers(List<F57BorrowerEntity> f57Borrowers) {
		this.f57Borrowers = f57Borrowers;
	}

	public F57BorrowerEntity addF57Borrower(F57BorrowerEntity f57Borrower) {
		getF57Borrowers().add(f57Borrower);
		f57Borrower.setF57Agency(this);

		return f57Borrower;
	}

	public F57BorrowerEntity removeF57Borrower(F57BorrowerEntity f57Borrower) {
		getF57Borrowers().remove(f57Borrower);
