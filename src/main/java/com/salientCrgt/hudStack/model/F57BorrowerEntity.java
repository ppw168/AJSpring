...
public class F57BorrowerEntity implements Serializable {
    ...
    public F57RefCaseCodeEntity getF57RefCaseCodeEntity() {
        return this.f57RefCaseCodeEntity;
    }
    ...
    public void setF57RefCaseCodeEntity(
            final F57RefCaseCodeEntity f57RefCaseCodeEntity) {
    ...
    public void setId(final F57BorrowerEntityPK id) {
        this.id = id;
    }

    public void setTxSuspendCode(final String txSuspendCode) {
